...
/**
 * Default knockd sequence generated by `soverstack init`.
 * This sequence is PUBLIC (in source code and docs) — users MUST change it.
 */
export const DEFAULT_KNOCKD_SEQUENCE = [7000, 8500, 9000, 12000];
...
# To connect: knock -v <host> <your-sequence> && ssh user@host
# IMPORTANT: Change the default sequence below! It is PUBLIC and must be replaced.
# Interface is auto-detected by Soverstack during bootstrap.

knockd:
  enabled: true
  sequence: [${DEFAULT_KNOCKD_SEQUENCE.join(", ")}]
  seq_timeout: 5
  port_timeout: 30
